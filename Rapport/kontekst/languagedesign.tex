...
\textbf{Reserved calls} are methods used to make the robtos behaviour, this is needed to e.g. make the robot shoot, scan for other robots and move around the battlefield. 

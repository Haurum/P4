...
\end{math}
 ...
 The purpose of the semantics functions is interpret syntactic elements to semantic elements. The semantic functions used in our language will be described in this section. 
  ...
  \begin{math}  
	  \boldsymbol{EnvV} = \boldsymbol{Var} \cup \{ next \} \rightharpoonup \ \boldsymbol{Loc}
  \end{math}
  
  Let l be an arbitray element of \textbf{Loc} and always assume that \textbf{Loc} = \begin{math} \mathbb{N}. \end{math}
  ...
  \subsection{Declarations}
  	\[
  		...
  		\]
  	   	...
  	   	\[
  	   	[VARDCL] \quad
  	   	\dfrac{\langle \ D_v, \ E_v[x \mapsto l]\rangle \ \rightarrow_{Dv} \ \langle \ E_v^{'} \ \rangle }{ \langle var \ x; \ D_v,\ E_v \rangle \rightarrow_{Dv} \ \langle E_v^{'} \rangle }
  	   	\qquad \ \ l = E_v(next)
  	   	\]
  	  	...
  	  	\[
  	   	[ACTDCL] \quad
  	   	\dfrac{E_v \ \vdash \langle D_a, \ E_a[a \ \mapsto (S, \ (x_1 .. x_n) \ E_v)] \ \rangle \rightarrow_Da \ E_a^{'}}{E_v \ Action \ a(x_1 .. x_n) \ is \ S; \ D_a \ E_a \ \rightarrow_{Da} \ E_a^{'}}
  	   	\]
  	   	...
  	   	\[
  	   	[FUNCDCL] \quad
  	   	\dfrac{E_v \vdash \langle D_f, \ E_f[f \ \mapsto (S, \ x_1 .. x_n, \ E_v)] \rangle \rightarrow_{Df} E_f^{'}}{E_v \vdash <Function \ f(x_1 .. x_2) \ is \ S; D_f, \ E_f > \rightarrow_{Df} \ E_f^{'}}
  	   	\]
